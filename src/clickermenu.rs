...
let backgroundcolor = Color::from_hex(0xD1B78E);
    ...
    loop {
        ...
        if is_key_pressed(KeyCode::Space) {
            return ("clicker".to_string(), tm, chickenclickerscore, gemcollectorscore);
        }
